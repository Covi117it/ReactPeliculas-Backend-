...
namespace PeliculasApi.Controllers
{
    ...
    public class UsuariosController: ControllerBase
    {
        ...
        public async Task<ActionResult<List<UsuarioDTO>>> ListadoUsurios([FromQuery] PaginacionDTO paginacionDTO)
        {
        ...
        [HttpPost("registrar")]
        [AllowAnonymous]
        public async Task<ActionResult<RespuestaAutenticationDTO>> Registrar(CredencialesUsuarioDTO credencialesUsuarioDTO)
        {
        ...
        private async Task<RespuestaAutenticationDTO> ConstruirToken(IdentityUser identityUser)
        {
            var claims = new List<Claim>
            {
                new Claim("email", identityUser.Email!),
                new Claim("hola jejejeje", "adios jejejeje")
            };
