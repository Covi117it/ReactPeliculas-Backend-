...
namespace PeliculasApi.Controllers
{
    ...
    public class CinesControllers: CustomBaseController
    {
        ...
        public CinesControllers(ApplicationDbContext context, IMapper mapper, IOutputCacheStore outputCacheStore)
